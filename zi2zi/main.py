...
model_filename = '../models/zi2zi/model.onnx'
...
def main():
    ...
    real_data = text_to_np(text, src_font, canvas_size, char_size)
    embedding_ids = [dst_embedding_id] * real_data.shape[0]

    fake_data = sess.run(['generator_1/Tanh:0'], {
        'real_A_and_B_images:0': real_data,
        'embedding_ids:0': embedding_ids
    })[0]
